...
import frc.robot.util.Cameras.PhotonRunnable;;
...
public class AprilTagSubsystem extends SubsystemBase {
  ...
  PhotonRunnable photonEstimator1 = new PhotonRunnable("Camera 1", VisionConstants.ROBOT_TO_APRILTAG_CAMERA1);
  PhotonRunnable photonEstimator2 = new PhotonRunnable("Camera 2", VisionConstants.ROBOT_TO_APRILTAG_CAMERA2);
  PhotonRunnable photonEstimator3 = new PhotonRunnable("Camera 3", VisionConstants.ROBOT_TO_APRILTAG_CAMERA3);
  PhotonRunnable photonEstimator4 = new PhotonRunnable("Camera 4", VisionConstants.ROBOT_TO_APRILTAG_CAMERA4);
  ...
  public AprilTagSubsystem() {
    ...
    .getStructTopic("MyPose-Cameras", Pose3d.struct).publish();
  }
  ...
  public void setAlliance(Alliance alliance){
    ...
    if (allianceChanged && sawTag) {
     ...
     // TODO Check if this is need i assume CTRE does it one its own
      // var newPose = flipAlliance(Robot.m_robotContainer.m_swerveBasePose.getOdometry().getEstimatedPosition());
      // resetPose(Robot.m_robotContainer.Telemetry.drivepose, Robot.m_robotContainer.m_swerveBasePose.getModulePositions(), newPose);
    }
  }
  ...
  public void updatedPoseFromTagTeleOp(){
    ...
    if (visionPose1 != null) {
      ...
      RobotContainer.drivetrain.addVisionMeasurement(pose2d1, visionPose1.timestampSeconds);
    ...
    if (visionPose2 != null) {
      ...
      RobotContainer.drivetrain.addVisionMeasurement(pose2d2, visionPose2.timestampSeconds);
    }
    if (visionPose3 != null) {
      // New pose from vision
      sawTag = true;
      ...
      RobotContainer.drivetrain.addVisionMeasurement(pose2d3, visionPose3.timestampSeconds);
    }
    if (visionPose4 != null) {
      // New pose from vision
      sawTag = true;
      ...
      RobotContainer.drivetrain.addVisionMeasurement(pose2d4, visionPose4.timestampSeconds);
    }
...
//     if (ComputerInterface.Camera1_InAuto == true ) {
//     if (visionPose1 != null) {
//       // New pose from vision
//       sawTag = true;
//       Pose2d pose2d1 = visionPose1.estimatedPose.toPose2d();
...
//     if (ComputerInterface.Camera2_InAuto == true ) {
//     if (visionPose2 != null) {
//       // New pose from vision
//       sawTag = true;
//       Pose2d pose2d2 = visionPose2.estimatedPose.toPose2d();
...
//   if (ComputerInterface.Camera3_InAuto == true ) {
//     if (visionPose3 != null) {
//       // New pose from vision
//       sawTag = true;
//       Pose2d pose2d3 = visionPose3.estimatedPose.toPose2d();
...
//   if (ComputerInterface.Camera4_InAuto == true ) {
//     if (visionPose4 != null) {
//       // New pose from vision
//       sawTag = true;
//       Pose2d pose2d4 = visionPose4.estimatedPose.toPose2d();
...
//   //Limlight Example
//   if (ComputerInterface.Camera5_InAuto == true ) {
//     LimelightHelpers.PoseEstimate limelightMeasurement = LimelightHelpers.getBotPoseEstimate_wpiBlue("limelight-tags");
//     if(limelightMeasurement.tagCount >= 1){
//           RobotContainer.drivetrain.addVisionMeasurement(limelightMeasurement.pose, limelightMeasurement.timestampSeconds);
//         }
...
//     //   }
//     //   RobotContainer.drivetrain.addVisionMeasurement(pose2d5, visionPose5.timestampSeconds);
//     // }
//     // This method will be called once per scheduler run
//     // System.out.println("Pose: " + Robot.m_robotContainerm_swerveBasePosegetPose3d());
//     // publisher.set(Robot.m_robotContainer.drivetrain.getPose3d());
//     }
